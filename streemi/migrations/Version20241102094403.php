 ...
 */
final class Version20241102094403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE playlist_subscriptions_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE categorie (id INT NOT NULL, name VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id INT NOT NULL, comment_media_id INT DEFAULT NULL, replies_id INT NOT NULL, content TEXT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CF7DBBE73 ON comment (comment_media_id)');
        ...
        $this->addSql('CREATE TABLE movie (id INT NOT NULL, media_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1D5EF26FEA9FDD75 ON movie (media_id)');
        $this->addSql('CREATE TABLE playlist (id INT NOT NULL, creator_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D782112D61220EA6 ON playlist (creator_id)');
        $this->addSql('COMMENT ON COLUMN playlist.create_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN playlist.updated_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE playlist_subscriptions (id INT NOT NULL, subscription_id INT DEFAULT NULL, subscriber_id INT NOT NULL, user_id INT NOT NULL, subscribed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_12B0B1B49A1887DC ON playlist_subscriptions (subscription_id)');
        $this->addSql('CREATE INDEX IDX_12B0B1B47808B1AD ON playlist_subscriptions (subscriber_id)');
        $this->addSql('COMMENT ON COLUMN playlist_subscriptions.subscribed_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE serie (id INT NOT NULL, media_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subscription_history (id INT NOT NULL, subscription_id INT NOT NULL, subscriber_id INT NOT NULL, user_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, current_subscription_id INT NOT NULL, watch_history_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, account_status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE watch_history (id INT NOT NULL, watch_history_media_id INT DEFAULT NULL, user_id INT NOT NULL, media_id INT NOT NULL, last_watched TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, number_of_views INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DE44EFD8A90060CC ON watch_history (watch_history_media_id)');
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CF7DBBE73 FOREIGN KEY (comment_media_id) REFERENCES media (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C7927FBC6 FOREIGN KEY (replies_id) REFERENCES comment (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26FEA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE playlist_subscriptions ADD CONSTRAINT FK_12B0B1B49A1887DC FOREIGN KEY (subscription_id) REFERENCES playlist (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE playlist_subscriptions ADD CONSTRAINT FK_12B0B1B47808B1AD FOREIGN KEY (subscriber_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE serie ADD CONSTRAINT FK_AA3A9334EA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D6494D8CCBCC FOREIGN KEY (watch_history_id) REFERENCES watch_history (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE watch_history ADD CONSTRAINT FK_DE44EFD8A90060CC FOREIGN KEY (watch_history_media_id) REFERENCES media (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE playlist_subscriptions_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE comment DROP CONSTRAINT FK_9474526CF7DBBE73');
        $this->addSql('ALTER TABLE comment DROP CONSTRAINT FK_9474526C7927FBC6');
        ...
        $this->addSql('ALTER TABLE movie DROP CONSTRAINT FK_1D5EF26FEA9FDD75');
        $this->addSql('ALTER TABLE playlist DROP CONSTRAINT FK_D782112D61220EA6');
        $this->addSql('ALTER TABLE playlist_subscriptions DROP CONSTRAINT FK_12B0B1B49A1887DC');
        $this->addSql('ALTER TABLE playlist_subscriptions DROP CONSTRAINT FK_12B0B1B47808B1AD');
        $this->addSql('ALTER TABLE season DROP CONSTRAINT FK_F0E45BA9D94388BD');
        $this->addSql('ALTER TABLE serie DROP CONSTRAINT FK_AA3A9334EA9FDD75');
        ...
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT FK_8D93D6494D8CCBCC');
        $this->addSql('ALTER TABLE watch_history DROP CONSTRAINT FK_DE44EFD8A90060CC');
